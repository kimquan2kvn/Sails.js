...
module.exports = {
  listUsers: function (req,res,_next){
    try {
  ...
  createStudent:async function(req,res,_next){
    try {
      if(req.data.role === 'admin') {
        ...
        res.json({code: 0 , message: 'Not permission!'});
    };
    } catch (error) {
      console.log(error);
    }
  ...
  editUsers: async function(req,res,_next){
    try {
  ...
  deleteUsers : async (req,res,_next)=>{
    try{
