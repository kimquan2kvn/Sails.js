...
const collection = client.db('sails').collection('users');
module.exports={
  ...
  register:function(req,res){
    ...
    // }
    users.createIndex({firstName:req.body.firstName, lastName:req.body.lastName,email:req.body.email,password:req.body.password}).exec((err) => {
      if(err){
