...
module.exports = {
  ...
  register: async function (req, res) {
    try {
      ...
      Users.validRegister(req.body.firstName);
      Users.validRegister(req.body.lastName);
      Users.validRegister(req.body.emailName);
      Users.validRegister(req.body.passwordName);
