...
module.exports.routes = {
  ...
  ***************************************************************************/
  ...
  'get /api/tasks': 'TaskController.getTasks', 'post /api/task': 'TaskController.createTask', 'put /api/task/:id': 'TaskController.updateTask', 'delete /api/task/:id': 'TaskController.deleteTask'
